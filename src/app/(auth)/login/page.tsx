                    ...
                    <div className="p-8 space-y-8">
                        ...
                        <form className="space-y-4">
                            ...
                            <div className="flex items-center gap-2 text-xs text-gray-500">
                                <input type="checkbox" id="remember" className="rounded border-white/10 bg-[#111113] text-primary focus:ring-primary/30 focus:ring-offset-0" />
                            ...
                            <div className="pt-2">
                                ...
                                <div className="mt-6 text-center">
                                    <Link href="/login/forgot-password" className="text-xs text-gray-500 hover:text-gray-300 transition-colors">
