...
export const WorkOrderSchema = z.object({
    ...
    property_address_or_unit: z.string().min(1, 'Property address/unit is required'),
    status: z.enum(['Draft', 'Scheduled', 'In Progress', 'Completed']).default('Draft'),
...
export const WorkOrderTaskSchema = z.object({
    ...
    status: z.enum(['Unassigned', 'Scheduled', 'In Progress', 'Completed']).default('Unassigned'),
