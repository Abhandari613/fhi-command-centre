...
import { X, CheckCircle, AlertCircle, FileText, Trash2, Building, MapPin, Wrench } from "lucide-react";
import { approveWorkOrderDraft, deleteWorkOrderDraft } from "@/app/actions/draft-actions";
...
export function ReviewDraftModal({ draft, onClose }: { draft: Draft | null; onClose: () => void }) {
                        ...
                        <div className="flex items-center justify-between p-6 border-b border-white/10 relative overflow-hidden">
                            ...
                            <div>
                                ...
                                <Dialog.Description className="text-sm text-white/60 mt-1">
                                    AI extracted these details. Please verify and fill in any missing info.
                                </Dialog.Description>
                            </div>
                        ...
                        <div className="p-6 overflow-y-auto custom-scrollbar flex-1 space-y-6">
                            {hasIssues && (
                                <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4 flex gap-3 text-red-200">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-red-300">Missing Information Detected</h4>
                            ...
                            <form id="approve-form" action={actionApprove} className="space-y-4">
                                <GlassCard className="p-5 space-y-4">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-1.5">
                                            <label className="text-xs font-medium text-white/50 uppercase tracking-wide flex items-center gap-1.5">
                                                <MapPin className="w-3.5 h-3.5" /> Unit / Address <span className="text-red-400">*</span>
                                            </label>
                                            <input
                                                ...
                                                className={cn(
                                                    ...
                                                    !data.property_address_or_unit ? "border-red-500/50 focus:ring-red-500/50" : "border-white/10 focus:ring-brand-primary/50"
                                                )}
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-medium text-white/50 uppercase tracking-wide px-1">Original Transcript / Message</label>
