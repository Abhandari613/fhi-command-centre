...
export const EditField = ({ label, value, onChange, placeholder, icon: Icon, type = "text", options = [], isEditing }: EditFieldProps) => (
        ...
        {isEditing ? (
            type === 'textarea' ? (
                ...
                <select
                    ...
                    onChange={e => onChange(e.target.value)}
                >
                    <option value="" disabled className="bg-zinc-900 text-zinc-500">{placeholder || "Select..."}</option>
                    {options.map((opt) => {
...
export const AddressEditField = ({ label, value, onChange, placeholder, icon: Icon, isEditing }: EditFieldProps) => {
        ...
        <div className="space-y-1 relative">
            ...
            {isEditing ? (
                <div className="relative">
                    ...
                    {!ready && scriptLoaded && <div className="text-xs text-red-500 absolute right-0 top-0">Places API not ready</div>}
