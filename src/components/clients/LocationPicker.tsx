      ...
      {isCreating ? (
        ...
        <div className="grid grid-cols-1 gap-2">
          {defaultAddress && (
            ...
            >
              <div
                className={`mt-0.5 w-4 h-4 rounded-full border flex items-center justify-center ${selectedLocationId === null ? "border-purple-400" : "border-white/30"}`}
              >
                {selectedLocationId === null && (
              ...
              <div>
                <h4
                  className={`text-sm font-medium ${selectedLocationId === null ? "text-purple-300" : "text-gray-200"}`}
                >
                  Client Default{" "}
                  <span className="text-[10px] bg-white/10 text-white/50 px-1.5 py-0.5 rounded ml-2">
                    Profile
                  </span>
                </h4>
          ...
          {locations.map((loc) => (
            ...
            >
              ...
              <div
                className={`mt-0.5 w-4 h-4 rounded-full border flex items-center justify-center relative z-10 ${
                  selectedLocationId === loc.id
                    ? "border-purple-400"
                    : "border-white/30"
                }`}
              ...
              <div className="relative z-10">
                <h4
                  className={`text-sm font-medium ${selectedLocationId === loc.id ? "text-purple-300" : "text-gray-200"}`}
                >
                  {loc.name}{" "}
                  {loc.is_primary && (
                    <span className="text-[10px] bg-white/10 text-white/50 px-1.5 py-0.5 rounded ml-2">
