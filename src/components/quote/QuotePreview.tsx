...
export function QuotePreview({
  ...
  const quoteData = {
    ...
    labour: 2500.0,
    materials: [
      { name: "Porcelain Floor Tiles (50 sq ft)", price: 450.0 },
      { name: "Vanity Unit & Sink", price: 850.0 },
      { name: "Grout & Adhesive", price: 150.0 },
      { name: "Paint & Primer", price: 300.0 },
    ],
    clientSupplies: ["Bathroom Mirror", "Towel Rails", "Toilet Roll Holder"],
  };
  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-4 animate-in fade-in slide-in-from-bottom-8">
      ...
      <GlassCard
        intensity="bright"
        className="p-6 flex justify-between items-center border-l-4 border-l-emerald-500"
      >
        <div>
      ...
      <GlassCard className="p-6 space-y-6">
        ...
        <div className="bg-white/5 p-4 rounded-lg space-y-2">
          <span className="text-xs uppercase tracking-wider font-bold text-amber-500 opacity-90">
