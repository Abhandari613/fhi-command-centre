...
export function ReceiptScanner() {
  ...
  const handleUpload = async (file: File) => {
    ...
    try {
      ...
      const { processAndSaveReceipt } =
        await import("@/app/actions/receipt-actions");
      ...
      <div className="relative flex flex-col items-center justify-center gap-6 min-h-[400px]">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <p className="opacity-60 text-sm max-w-[250px] mx-auto font-medium mb-4">
                Align receipt within the frame for auto-detection and OCR
                extraction.
              </p>

              <div className="max-w-[250px] mx-auto text-left mb-6">
                <label className="block text-[10px] font-bold uppercase opacity-70 mb-1 tracking-wider text-white">
                  Tag Work Order (Optional)
                </label>
                <GlassSelect
        ...
        {status === "success" && (
          ...
          >
            <GlassCard
              intensity="bright"
              className="p-10 flex flex-col items-center gap-4 border-emerald-500/30 bg-emerald-500/5"
            >
              ...
              <div className="text-center space-y-2">
                ...
                {matchResult?.matched ? (
                  ...
                  <p className="text-white/40 text-sm">
                    Receipt saved (No transaction match yet)
                  </p>
                )}
              </div>
            </GlassCard>
